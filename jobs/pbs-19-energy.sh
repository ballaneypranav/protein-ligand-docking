...
#PBS -q novoq
#PBS -o 19-energy-npt-pbs.out
#PBS -e 19-energy-npt-pbs.err
#PBS -j oe
...
time
pwd
mpirun -np 1 gmx_mpi energy -f 17-npt.edr -o 19-npt-pressure.xvg << EOF 2>&1 | tee 19-energy-pressure.log
19 0
exit
