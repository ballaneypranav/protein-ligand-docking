...
#PBS -q novoq
#PBS -o 3-editconf-pbs.out
#PBS -e 3-editconf-pbs.err
#PBS -j oe
...
time
pwd
mpirun -np 1 gmx_mpi editconf -f 2-complex.gro -o 3-newbox.gro -bt dodecahedron -d 1.0 2>&1 | tee 3-editconf.log
exit
