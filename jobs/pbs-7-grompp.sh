...
#PBS -q novoq
#PBS -o 7-grompp-pbs.out
#PBS -e 7-grompp-pbs.err
#PBS -j oe
...
time
pwd
mpirun -np 1 gmx_mpi grompp -f em.mdp -c 6-neutralized.gro -p topol.top -o 7-neutralized.tpr 2>&1 | tee 7-grompp.log
exit
